    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm border-b border-gray-200 h-20">
      <nav className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <a
          ...
          className="px-4 py-2 border border-[#0866FF] bg-[#0867ff1d] text-black font-medium rounded-lg hover:bg-[#0866FF] hover:text-white transition-colors inline-block text-center"
        >
          {tAbout('facebook')}
        </a>
